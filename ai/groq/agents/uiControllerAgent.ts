...
// import { uiControllerTools } from "../tools.ts/uiControllerTools.js";
// import Collection from "../../../models/collection.js";

// const groq = new Groq({ apiKey: activeAiApiKey });

// export const uiControllerAgent = async (msg: string, history: any[]) => {
...
//         {
//             role: "system",
//             content: `You are a ui controller agent.
//             Rules:
//             1. ONLY use 'controlUI' tool for controlling UI elements.
//             2. 'element' is optional. If the user asks for a category without a name, leave query empty.
