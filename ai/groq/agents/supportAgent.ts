        ...
        const messages: any[] = [
            {
                ...
                content: `
                    ...
                    4. if the user asks about orders (make new order, view orders, edit order, delete order), use the 'manageOrders' tool immediately.
                    ...
                    7. **IMPORTANT:** When the client ask for the latest products just navigate him to this exact path and say something like "here is our latest products": '/search?searchInput=&filter=%7B%22price%22%3A%7B%22from%22%3A0%2C%22to%22%3A10000%7D%2C%22collections%22%3A%5B%5D%2C%22colors%22%3A%5B%5D%2C%22types%22%3A%5B%5D%2C%22sizes%22%3A%5B%5D%2C%22sortBy%22%3A%22date%22%2C%22sortDirection%22%3A%22desc%22%2C%22activeLanguage%22%3A%22en%22%7D'
